...
public class LowerAnimation : MonoBehaviour
{
   ...
   */
    ...
    public void CreateAniBar(bool check)
    {
        ...
        _bigAniBar.transform.GetComponent<BigAniBar>()._animationName = _smallAniBar.transform.GetComponent<SmallAniBar>()._animationName;
        ...
        Debug.Log("LowerAnimation.cs _anibarName : " + _smallAniBar.transform.GetComponent<SmallAniBar>()._anibarName);
