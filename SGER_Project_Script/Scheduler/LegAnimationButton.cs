...
public class LegAnimationButton : MonoBehaviour
{
    ...
    public void OnClickAction()
    {
        ...
        {
            _aniBarParent = _aniBarParent.transform.Find("Woongin" + (_clickedItemControl._clickedItem._objectNumber)).transform.GetChild(4).gameObject;
            _smallAniBarParent = _smallAniBarParent.transform.Find("Woongin" + (_clickedItemControl._clickedItem._objectNumber)).transform.GetChild(3).gameObject;
        }
        ...
        Debug.Log("LegAnimation.cs _anibarName : " + _smallAnimationBar.transform.GetComponent<SmallAniBar>()._anibarName);

        HistoryController.pushAniBarCreateHist(_animationBar, _smallAnimationBar, _smallAnimationBar.transform.GetComponent<SmallAniBar>()._animationName, _animationBar.gameObject.name, _clickedItemControl._clickedItem._objectNumber, 1);
        /*
            History
            date   : 2018-11-26
            author : Lugup
